...
export function SidebarNav() {
  ...
  const progress = Math.min(
    Math.round((vault.balance / vault.threshold) * 100),
    100,
  );
  ...
  return (
    <aside
      className="hidden md:flex h-full w-[240px] flex-col border-r flex-shrink-0"
      style={{
...
function NavGroup({
  ...
  return (
    <div>
      <p className="px-3 pb-1.5 text-[10px] uppercase tracking-[0.12em] text-text-muted font-semibold">
        {label}
      </p>
