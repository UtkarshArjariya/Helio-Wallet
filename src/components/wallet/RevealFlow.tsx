    ...
    <div className="flex flex-col">
      ...
      <div className="relative p-4 space-y-4" style={{ isolation: 'isolate' }}>
        ...
        <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-text-muted">
          ...
          <span
            className={cn(
              stage === 'reveal' && 'text-text-secondary',
              stage === 'verify' && 'text-text-muted/40',
            )}
          >
            {'02 // Reveal'}
          </span>
          ...
          <span
            className={cn(
              stage === 'done' && 'text-text-secondary',
              stage !== 'done' && 'text-text-muted/40',
            )}
          >
            {'03 // Acknowledge'}
          </span>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-eyebrow text-text-muted text-[10px] mb-1">
                  {props.intro}
                </div>
            ...
            <button
              ...
              style={
                verifying || !password ? { background: 'var(--surface-3)' } : {}
              }
            >
              {verifying ? (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-heading text-text-primary text-base font-bold">
                  {props.unsupportedHeadline}
                </h3>
                <p className="text-text-muted text-xs mt-1 leading-relaxed">
                  {props.unsupportedBody}
                </p>
              </div>
            </div>
            <button
          ...
          >
            ...
            >
              ...
              <span className="text-text-secondary text-xs leading-relaxed">
                I have stored this securely and understand that anyone with it
                can take everything from my wallet.
              </span>
            </label>
