...
function colorFor(symbol: string): { bg: string; fg: string } {
  switch (symbol.toUpperCase()) {
    case 'SOL':
      return { bg: 'var(--gradient-cosmic)', fg: '#FFFFFF' };
    case 'USDC':
      return { bg: '#2775CA', fg: '#FFFFFF' };
    case 'JUP':
      return { bg: '#22C55E', fg: '#06210F' };
    case 'JTO':
      return { bg: '#1A1FB8', fg: '#FFFFFF' };
    case 'PYTH':
      return { bg: '#1F2937', fg: '#C6F000' };
    case 'BONK':
      return { bg: '#FF3B3F', fg: '#FFFFFF' };
    default:
      return { bg: 'var(--accent-primary)', fg: '#000000' };
  }
}
