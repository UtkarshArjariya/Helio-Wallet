        ...
        <CardContent className="p-6 md:p-8 flex-1 flex flex-col space-y-6 overflow-y-auto">
          <div className="space-y-2 text-center md:text-left">
            <h3 className="font-heading font-bold text-lg">
              Paste your Solana private key
            </h3>
            <p className="text-sm text-text-muted">
              Base58 string from Phantom (Settings → Manage Accounts → Show
              Private Key) or any other Solana wallet. Don't paste your recovery
              phrase here — use the recovery-phrase import for that.
            </p>
          </div>
          ...
          <div className="mt-auto pt-6">
            <div className="p-4 bg-warning/10 rounded-xl border border-warning/20 mb-6">
              <p className="text-xs text-warning leading-relaxed">
                Never share your private key. Anyone with this key controls
                every asset on this wallet. Imported keys can't reconstruct a
                recovery phrase — back up the key string itself somewhere safe.
              </p>
            </div>
            <Button
              className="w-full"
