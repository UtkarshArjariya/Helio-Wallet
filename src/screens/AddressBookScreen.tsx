      ...
      <div className="p-4 space-y-3">
        {contacts.length === 0 ? (
          ...
          <>
            ...
            <div
              className="rounded-3xl helio-card overflow-hidden divide-y"
...
function ContactRow({
  ...
  return (
    <div className="group flex items-center gap-3 px-3 py-2.5 hover:bg-surface-3 transition-colors">
      ...
      {copied && (
        <span className="font-mono text-success text-[10px]">copied</span>
      )}
    </div>
  );
}
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          <div className="font-heading text-text-primary font-semibold">
            New contact
          </div>
          <button
            type="button"
        ...
        <label className="block space-y-1.5">
          <span className="font-eyebrow text-text-muted text-[10px]">
            Note{' '}
            <span className="text-text-muted normal-case font-sans tracking-normal">
              (optional)
            </span>
          </span>
          <input
