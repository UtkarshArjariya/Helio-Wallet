      ...
      render={(phrase, revealed) => {
        ...
        return (
          ...
          >
            {words.map((w, i) => (
              <div
                // biome-ignore lint/suspicious/noArrayIndexKey: recovery-phrase words can repeat, so position is required for uniqueness; the list is static and never reordered
                key={`${i}-${w}`}
