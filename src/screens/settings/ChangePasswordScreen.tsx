  ...
  return (
    <div className="flex flex-col">
      <ScreenHeader
        ...
        subtitle="Unlock password for this device"
      />
      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            help={
              next ? (
                ...
                <span className="text-text-muted text-[11px]">
                  At least 8 characters · mix cases, digits & symbols for strong
                </span>
              )
            }
          />
          <Field
            ...
            help={
              !matches ? (
                ...
                <span className="text-success text-[11px] inline-flex items-center gap-1">
        ...
        {done && (
          <div
            ...
            style={{
              ...
              borderColor: 'rgba(198,240,0,0.22)',
              color: 'var(--success)',
            }}
          >
        ...
        <p className="text-text-muted text-[11px] px-1 leading-relaxed">
          The unlock password protects your encrypted vault on this device. It
          is never sent to a server and cannot recover your funds — your 12-word
          phrase does that.
        </p>
      </form>
    </div>
