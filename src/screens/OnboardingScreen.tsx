    ...
    <div className="relative flex min-h-full flex-col items-center justify-between overflow-hidden p-6 helio-orbit-bg" style={{ minHeight: '100vh' }}>
      ...
      <div className="relative z-10 my-8 max-w-sm text-center">
        <div className="relative mx-auto mb-6 flex h-28 w-28 items-center justify-center">
          <div className="helio-pulse-ring absolute inset-0 rounded-full opacity-40 blur-2xl" style={{ background: 'var(--accent-primary)' }} />
          <div
            className="helio-float relative flex h-28 w-28 items-center justify-center rounded-3xl overflow-hidden"
