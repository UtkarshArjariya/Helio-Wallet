...
export function UnlockScreen() {
  ...
  const handleUnlock = async (e?: React.FormEvent) => {
    ...
    if (!vault) {
      setError(
        'No encrypted vault found on this device. Please restore using your recovery phrase.',
      );
      return;
    }
    ...
    try {
      ...
      setError(
        'Incorrect password. Try again, or use your recovery phrase to restore.',
      );
      setBusy(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -left-16 bottom-0 h-72 w-72 rounded-full"
            ...
            <label className="block space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  // biome-ignore lint/a11y/noAutofocus: intentional — focuses the input on mount for fast entry
                  autoFocus
      ...
      <div className="relative z-10 mt-6 max-w-xs text-center">
        <p className="text-text-muted text-[10px] leading-relaxed">
          Your password is local to this device. Helio cannot reset it. Use your
          12-word recovery phrase to restore on any device.
        </p>
      </div>
    </div>
  );
    ...
    <div className="space-y-3">
      ...
      >
        ...
        <span className="leading-relaxed">
          No encrypted vault was found on this device. To continue, restore your
...
function ResetDeviceConfirm({
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/useSemanticElements: styled interactive container kept as div with role=button + keyboard handler */}
      <div
        className="w-full max-w-md rounded-3xl helio-card p-5 space-y-3"
        role="button"
        tabIndex={0}
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="font-heading text-text-primary text-base font-bold">
              Forget this device
            </div>
            <p className="text-text-muted text-xs mt-1 leading-relaxed">
              Clears the local encrypted vault and label. The on-chain wallet is
              untouched — you can re-import it with your 12-word recovery
              phrase.
            </p>
          </div>
        </div>
