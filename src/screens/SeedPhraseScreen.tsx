      ...
      render={(phrase, revealed) => {
        ...
        return (
          ...
          >
            {words.map((w, i) => (
              <div
                // biome-ignore lint/suspicious/noArrayIndexKey: seed words can repeat within a phrase, so the word is not a unique key; this static list is never reordered, so the index is the stable identifier.
                key={i}
