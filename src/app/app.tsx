...
export function App() {
  ...
  const getPendingDappRequest = extensionClient.getPendingDappRequest;
  const getRuntimeSnapshot = extensionClient.getRuntimeSnapshot;

  useEffect(() => {
    let isCancelled = false;

    Promise.all([getPendingDappRequest(), getRuntimeSnapshot()])
  ...
  }, [getPendingDappRequest, getRuntimeSnapshot]);
